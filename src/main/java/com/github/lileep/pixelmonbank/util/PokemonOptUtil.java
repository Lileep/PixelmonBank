...
public class PokemonOptUtil {
    ...
    public static boolean isRestrict(Pokemon pokemon) {
        return isRestrict(pokemon.getTranslatedName().getString()) || isRestrict(pokemon.getSpecies().getName());
    }
    ...
    public static boolean isBlackList(Pokemon pokemon) {
        return isBlackList(pokemon.getTranslatedName().getString()) || isBlackList(pokemon.getSpecies().getName());
    }
